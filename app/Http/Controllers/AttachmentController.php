...
class AttachmentController extends Controller
{
    ...
    {
        $this->authorize('viewAny', [Attachment::class, $note]);
    ...
    public function store(Request $request, Note $note)
    {
        ...
        try {
            ...
            return response()->json([
                ...
                'debug_error' => $e->getMessage(), // Toto ti povie, čo je zle
                'line' => $e->getLine()
    ...
    public function destroy(Note $note, string $id)
    {
        $attachment = $note->attachments()->find($id);

        if (!$attachment) {
            return response()->json([
                'message' => 'Príloha nenájdená.'
